...
import StudentCardContent from './ReadCardContent'
import EditStudentCardContent from './UpdateStudentCardContent'
...
function ViewStudentCard() {
    ...
    const student = useSelector((state: RootState) => state.currentStudent.data) as Student
